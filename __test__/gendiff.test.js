...
test('gendiff', () => {
    ...
    expect(diff(getFixturePath('file1.json'), getFixturePath('file2.json') )).toBe(resultPlain)
    expect(diff(getFixturePath('filepath1.yml'), getFixturePath('filepath2.yml'))).toBe(resultPlain)
})
